        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    LEFT JOIN user ON post.author=user.user_id Where category=$id";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="inner-content clearfix">
                                        ...
                                        <a style="background-color: #738291;" class='read-more pull-right' href='single.php?id=<?php echo $rows['post_id'] ?>'>read more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
